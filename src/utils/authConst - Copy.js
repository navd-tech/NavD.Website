...
export const IDENTITY_CONFIG = {
  authority: process.env.GATSBY_AUTH_URL, // (string): The URL of the OIDC provider.
  client_id: process.env.GATSBY_IDENTITY_CLIENT_ID, // (string): Your client application's identifier as registered with the OIDC provider.
  redirect_uri: process.env.GATSBY_REDIRECT_URL, // The URI of your client application to receive a response from the OIDC provider.
  login: `${process.env.GATSBY_AUTH_URL}/login`,
  ...
  silent_redirect_uri: process.env.GATSBY_SILENT_REDIRECT_URL, // (string): The URL for the page containing the code handling the silent renew.
  post_logout_redirect_uri: process.env.GATSBY_LOGOFF_REDIRECT_URL, // (string): The OIDC post-logout redirect URI.
...
export const METADATA_OIDC = {
  ...
  jwks_uri: `${process.env.GATSBY_AUTH_URL  }/.well-known/openid-configuration/jwks`,
  ...
  check_session_iframe: `${process.env.GATSBY_AUTH_URL  }/connect/checksession`,
